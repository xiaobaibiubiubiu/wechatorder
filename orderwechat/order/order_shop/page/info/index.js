...
Page({
  ...
  formSubmit: function (e) {
    ...
    if (this.data.hasIconChange) {//有图标改变
      ...
      wx.uploadFile({
        url: 'https://bjshuyiyuan.com.cn/wechatorder/index.php/Apiwx/Wxgoodsupdate/updateOwnerInfo',
  ...
  updateIcon: function () { 
    ...
    if (hasIconChange) {
      ...
      wx.uploadFile({
        url: 'https://bjshuyiyuan.com.cn/wechatorder/index.php/Apiwx/Wxgoodsupdate/updateShopIcon',
        filePath: this.data.tempFilePaths,
        name: 'pic_url',
        header: { "Content-Type": "multipart/form-data" },
        formData: {
