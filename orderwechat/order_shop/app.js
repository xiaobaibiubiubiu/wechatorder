...
App({
	...
	login: function() {
        ...
        wx.request({
          url: 'https://bjshuyiyuan.top/wechatorder/index.php/Apiwx/Wxorder/doLogin?flag=0&code='+ res.code,
          success:function(res){
              ...
              that.globalData.hasLogin = true; 
               wx.request({
                 url: 'https://bjshuyiyuan.top/wechatorder/index.php/Apiwx/Wxmanager/judgeLogin?open_id=' + res.data.openid,
            success: function (res) {
              console.log(res);
              if (res.data != 0) {
